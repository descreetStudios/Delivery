<template>
  <div class="tracking-container">
    ...
    <div class="controls">
      ...
      <input v-model="testCourierId" placeholder="Courier ID" />
      <button @click="sendTestLocation" :disabled="sending">
    ...
    <div class="courier-list">
      ...
      <div v-if="couriers.length === 0" class="empty">
...
const { connect, disconnect, isConnected, lastLocation } = useLocationWebSocket()
